    ...
    public partial class QuanLiHocSinh : Form
    {
        ...
        private void formLoad()
        {
            ...
            foreach (var i in StudentDAO.Instance.getAllStudents())
            {
                ...
                listStu.Add(new Tuple<string, string, string, string, string, string>(i.IdStudent, i.NameStudent, sex , i.DateBirth.ToString("dd/MM/yyyy"), i.YearSchool, i.Classes));
            }
            ...
            duLieu.Columns["Item5"].HeaderText = "Năm học";
            duLieu.Columns["Item6"].HeaderText = "Lớp";
        }
        ...
        private void btnTim_click(object sender, EventArgs e)
        {
            ...
            foreach (var i in StudentDAO.Instance.getAllStudents())
            {
                ...
                if (i.IdStudent.ToLower().Contains(id.ToLower()))
                {
                    listStu.Add(new Tuple<string, string, string, string, string, string>(i.IdStudent, i.NameStudent, sex , i.DateBirth.ToString("dd/MM/yyyy"), i.YearSchool, i.Classes));
                }
            }
